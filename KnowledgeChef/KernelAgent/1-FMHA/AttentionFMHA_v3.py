...
def fmha_kernel(Q, K, V, Out,
    ...
    # Load query tile directly (Let cuTile decide staging)
    ...
    for j in range(0, Tc):
        # Load K with latency hint for software pipelining
        k = ct.load(
...
if __name__ == "__main__":
    ...
    print("--- Running cuTile Fused Multi-Head Attention (FMHA) v3 (Latency Hiding) ---")
