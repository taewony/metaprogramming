...
- do not send screenshots without explicit user approval
- do not commit private .agent/data-layer exports
description: Agent activity dashboard and data layer monitoring
---
